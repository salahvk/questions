#!/usr/bin/env python3
"""Append wave-20 world history questions (20 PSC topic types only)."""
...
from world_history_wave20_facts import generate_wave20_candidates

BASE = Path(__file__).parent
FILE = "world_history.json"
PREFIX = "wh_"
TARGET = 5200
