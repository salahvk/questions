# -*- coding: utf-8 -*-
"""All category data for indian_industries_wave30_facts (except starter 3 in _build file)."""
...
DIRECT_FACTS: list[tuple[str, str, list[str], str]] = [
    ...
    ("ആമുൽ സഹകരണ സംഘടനയുടെ സ്ഥളം?", "ആനന്ദ്", ["അഹമദാബാദ്", "മുംബൈ", "പുണെ"], "medium"),
    ...
    ("അമുൽ സംബന്ധിച്ച വിപ്ലവം?", "വെള്ള വിപ്ലവം", ["പച്ച വിപ്ലവം", "നീൽ വിപ്ലവം", "സ്വർണ്ണ വിപ്ലവം"], "medium"),
    ...
    ("ഇന്ത്യയുടെ ആദ്യ IT പാർക്ക്?", "SEEPZ (മുംബൈ)", ["ഇൽക്ട്രോണിക് സിറ്റി", "HITEC സിറ്റി", "ഐ.ടി.പി.എൽ"], "hard"),
]


def fill_data(d: dict[str, list[tuple[str, str]]], B: str) -> None:
    d["MSME_CATEGORY"] = [
    ...
    d["CORRIDORS"] = [
        ...
        (f"ചെന്നൈ-{B} കോറിഡോർ", "ഈസ്റ്റ് കോസ്റ്റ് ഇക്കണോമിക് കോറിഡോർ"),
        ("വിശാഖപട്ടണം-ചെന്നൈ കോറിഡോർ", "ആന്ധ്രപ്രദേശ്"),
        (f"{B}-മുംബൈ കോറിഡോർ", "കർണാടക & മഹാരാഷ്ട്ര"),
        ("ബിളാസ്പൂർ-ദുർഗാപൂർ കോറിഡോർ", "ഛത്തീസ്ഗഢ് & പശ്ചിമബംഗാൾ"),
        (f"ഹൈദരാബാദ്-{B} കോറിഡോർ", "ഇൽക്ട്രോണിക്സ് & ഐടി"),
