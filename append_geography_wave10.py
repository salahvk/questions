#!/usr/bin/env python3
"""Append wave-10 geography questions (10 PSC topic types only)."""
...
from geo_wave10_facts import generate_wave10_candidates, generate_wave10_wave2_candidates
...
def main() -> int:
    ...
    pool = generate_wave10_candidates(set(existing), rng)
    pool.extend(generate_wave10_wave2_candidates(set(existing), rng))
    rng.shuffle(pool)
