#!/usr/bin/env python3
"""Append wave-15 Indian history questions (15 PSC topic types only)."""
...
def main() -> int:
    ...
    pool = generate_wave15_candidates(set(existing), rng)
    rng.shuffle(pool)
